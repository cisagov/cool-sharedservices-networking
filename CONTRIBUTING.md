...
issue](https://github.com/cisagov/cool-shared-services-networking/issues)
...
request](https://github.com/cisagov/cool-shared-services-networking/pulls),
...
```console
cd cool-shared-services-networking
pyenv virtualenv <python_version_to_use> cool-shared-services-networking
pyenv local cool-shared-services-networking
